...
export const produits: Produit[] = [
  // --- Piments & Poivres ---
  { idProduit: 1, idTypeProduit: 1, nomProduit: "Piment Moulu", descriptionProduit: "Piment fort séché, idéal pour relever tous vos plats. Arôme intense et chaleur persistante.", prixProduit: 1000, quantiteStockProduit: 80, seuilAlertProduit: 15, imageProduit: "https://i.ibb.co/WWVWxfjg/Whats-App-Image-2026-01-14-at-16-00-51.jpg", statutProduit: "actif", dateAjoutProduit: "2025-01-10" },
  ...
  { idProduit: 4, idTypeProduit: 1, nomProduit: "Poivre blanc", descriptionProduit: "Poivre long d'Afrique, saveur piquante et légèrement sucrée. Rare et traditionnel.", prixProduit: 3500, quantiteStockProduit: 30, seuilAlertProduit: 8, imageProduit: img("4198933"), statutProduit: "actif", dateAjoutProduit: "2025-01-15" },
